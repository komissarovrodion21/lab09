...
```ShellSession
$ git clone https://github.com/${GITHUB_USERNAME}/lab04 lab06 #клонирование репозитория lab04 в lab06
$ cd lab06 #выбираем директорию lab06
$ git remote remove origin #отключаемся от удаленного репозитория 4 лабораторной
$ git remote add origin https://github.com/${GITHUB_USERNAME}/lab06 #подключаемся к удаленному репозиторию 5 лабораторной
```
